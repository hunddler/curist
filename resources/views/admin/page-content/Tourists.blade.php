	            ...
	            <div class="row">
	            	<div class="col-md-10">
	            		<div class="card card-custom">
							...
							<form method="post" action="{{url('add/tourist')}}" enctype="multipart/form-data">
								@csrf	
								<input type="hidden" name="section" value="tourist">
								<input type="hidden" name="oldimage" value="@if($data){{$data->logo}}@endif">	
								...
								<div class="row">
                                    ...
                                    <div class="col-md-12">
								        <div class="form-group">
								            ...
								            <input type="text" class="form-control input-lg" required  name="sub_heading" value="@if($data){{$data->sub_heading}}@endif">
								        </div>
								    </div>
									<div class="col-md-6">
								        <div class="form-group">
								    ...
								    <div class="col-md-6">
								        <div class="form-group">
											...
											<img src="@if($data){{asset('assets/'.$data->logo)}}@endif" height="50" width="50">
