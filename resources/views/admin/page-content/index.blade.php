	            ...
	            <div class="row">
	            	<div class="col-md-10">
	            		<div class="card card-custom">
							...
							<form method="post" action="{{url('add/homesection')}}" enctype="multipart/form-data">
								@csrf	
								...
								<div class="row">
									...
									<div class="col-md-6">
								        <div class="form-group">
											...
											<img src="{{asset('assets/'.$data->btn_text)}}" height="50" width="50">
									...
									<div class="col-md-6">
								        <div class="form-group">
											...
											<img src="{{asset('assets/'.$data->btn_text_1)}}" height="50" width="50">
								    ...
								    <div class="col-md-6">
								        <div class="form-group">
											...
											<img src="{{asset('assets/'.$data->logo)}}" height="50" width="50">
